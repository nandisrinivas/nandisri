...
for run in range(10):
    ...
    for i in range(9):
        ...
        data = datasets.split_anomaly_mnist([normal_classes[0]], anomaly)
    ...
    # # Load data for evaluation
    # data = datasets.split_anomaly_mnist(normal_classes[0:1], anomaly)
    # [eval_data, eval_labels] = data.get_eval_samples()
    # eval_data = eval_data / 255.0
    #
    ...
    hp_dict = {"pic_size": pic_size, "enc_neurons": enc_neurons, "code_size": code_size, "dec_neurons": dec_neurons,\
            "batch_size": batch_size, "learning_rate": learning_rate, "epochs": epochs, "lmbd": lmbd,\
